...
0. `mcp-hook-tool-layer.md`：Camoufox / CloakBrowser MCP、pre-inject、runtime_probe、Cookie 归因。
...
0. 有 Camoufox MCP 或 CloakBrowser MCP 可用时，先读 `mcp-hook-tool-layer.md` 决定是否用 pre-inject、runtime_probe 或 Cookie 归因。
